...
```{r}
str(md)
results.fname.noext <- paste0("00_data_up_to_", format(Sys.Date(), "%y%m"))
readr::write_csv(md, paste0(results.fname.noext,".csv"))
openxlsx::write.xlsx(md, file = paste0(results.fname.noext, ".xlsx"))
