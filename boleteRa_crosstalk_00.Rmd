...
#    addTiles(tilesURL, 	attribution='Map tiles by <a href="http://server.arcgisonline.com">ArcGIS online</a> &mdash; Map data &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>') %>% 
    ...
    addMarkers(label = ~as.character(d$`nom vulgar (comestible)`),
               popup = paste(
                 "Name1:", d$`nom vulgar (comestible)`, "<br>",
                 "Name2:", d$`nom vulgar (no comestible)`, "<br>",
                 "Abundance:", d$Abundància, "<br>",
                 "Mushroom Details:", d$`Detalls del bolet`, "<br>",
                 "Forest density:", d$`Densitat del sotabosc`, "<br>",
                 "Site desc:", d$`Descripció del lloc`, "<br>",
                 "Slope:", d$Pendent, "<br>",
                 "Picture:", d$foto, "<br>",
                 "Date:", d$Date
                 ),
...
#    overlayGroups = c("Edible", "Non Edible"),
    ...
    # Legend
    addLegend("bottomright", colors= "blue", labels="My findings", title="Catalonia"),
